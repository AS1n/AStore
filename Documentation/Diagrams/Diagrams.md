...
![Autorization state](./State/Authorization.png)

<a name="4.2"/>

##### 4.2 Создание кошелька

![Wallet creation state](./State/WalletCreation.png)

<a name="4.3"/>

##### 4.3 Оформление подписки

![Subscription state](./State/Subscription.png)
